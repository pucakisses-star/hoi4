...
SPLIT = {
    "Schleswig": {
        "PRS": [11251, 11366, 317, 6389, 3231, 6257, 3368, 9320],
        "HAM": [9347],    # Hamburg, free city
        "LUB": [11331],   # Lubeck, free city
        "OLD": [13664],   # Principality of Lubeck (Eutin) -- Oldenburg exclave
    },
    "East Prussia":      {"PRS": [395, 6332, 3384, 6402, 9327, 266, 11245, 9398,
                                  3380, 11386, 3351, 6375, 9372, 9346]},
    "Eastern Pomerania": {"PRS": [11343, 11372, 11316, 9361, 9334, 11288, 6334,
                                  9306, 9277, 11260, 6309, 6282, 6390, 9252]},
    "Pomerania":         {"PRS": [9388, 3340, 349, 3258, 3312, 3207]},
    "Ostmark":           {"PRS": [9387, 6236, 537, 11478, 3473, 444, 3572]},
    "Rhineland":         {"PRS": [3512, 3444, 6469, 9482, 6570, 587, 9522, 529, 3547]},
    "Lower Silesia":     {"PRS": [3438, 9470, 3510, 6595, 3283, 552, 6462, 11517,
                                  6534, 9570, 3545, 3485]},
    "Upper Silesia":     {"PRS": [479, 9511, 506, 6512, 11467, 9457, 13663]},
    "Posen":             {"PRS": [11232, 388, 3381, 6558, 17, 3532, 9532, 3460, 11558]},
    "Pomerellen":        {"PRS": [9263, 362, 389, 334, 3324, 6347, 3295, 279, 243]},
    ...
    "Brandenburg": {
        "PRS": [11219, 3367, 11444, 375, 11359, 11505, 13497, 6521, 9496, 9456,
    ...
    "Hannover": {
        "PRS": [374, 6349, 6325, 3326, 6298, 9264, 3271, 6263, 9238, 6218,
    ...
    "Saxony": {
        ...
        "PRS": [6441, 11545, 9535, 3535, 514, 3514],  # Prussian Saxony and Lusatia
    },
    "Weser-Ems": {
        "PRS": [11360, 13839, 11264, 3234, 247, 9281, 11233, 11388],  # East Frisia, Emsland, Osnabruck
        "OLD": [241, 13562, 336],   # Oldenburg proper
        "BRE": [309],               # Bremen, free city
    },
    "Westphalia": {
        "PRS": [11346, 9509, 6622, 6535, 11431, 495, 3398],
        "SLP": [405],    # Schaumburg-Lippe, Buckeburg
        "LIP": [3355],   # Lippe, Detmold
        "WLD": [9443],   # Waldeck-Pyrmont, Arolsen
    },
    "Eastern Hesse": {
        "PRS": [564, 13665, 9524, 11533, 3524, 9547, 11445, 3397, 6488, 6444],
    ...
    "Palatinate": {
        "PRS": [13448, 11494, 11470, 11435, 9575],  # Prussian Rhine Province
    ...
    "Wurttemberg": {
        ...
        "PRS": [9517, 6934],   # Hohenzollern, the dynasty's ancestral land, ruled from Berlin
    },
    ...
    "Thuringia": {
        ...
        "PRS": [3561, 6582],  # the Harz, and Halle in Prussian Saxony
    },
}

NAMES = {
    "PRS": "Prussia", "BAV": "Bavaria", "SXY": "Saxony", "WUR": "Wurttemberg",
