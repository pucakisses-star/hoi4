...
Open the config file to adjust what it scans for. Should auto detect mod and HOI4 location, if it is having trouble place it in the mod folder you want it to scan.

Credits:

Created by Sir Rogers
Suggestions, bug testing and localisation by Zankoas
Shout out to the Kaiserreich team for being a guinea pig to test this on
